...
$config['tables']['login_attempts']  = 'login_logs';
...
$config['identity']                   = 'user_login';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
